...
<body dir="ltr">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu">
					<li><a href="MdpE.php?lang=fr"><img src="images/fr.png" width="25px"
							height="25px" /><?php echo $lang['lang_fr'] ?></a></li>
					<li><a href="MdpE.php?lang=en"><img src="images/en.png" width="25px"
	...
	<div class="row">
		...
		<div class="container-fluid content col-sm-8" align="center">
			...
			<h2><?php echo $lang['MDB'] ?></h2>
			<form action="oblieE.php"  class="form-group" method="post" name="f">
				<div class="form-group">
					<input type="text" placeholder="<?php echo $lang['email'] ?>"
						class="form-control hint" id="email" name="email" required>
				</div>
				<div class="form-group">
					<input type="password" placeholder="<?php echo $lang['ENT6'] ?>"
						class="form-control hint" id="tel" name="tel" required>
				</div>
				<button type="submit"
					class="btn btn-warning margin-item margin-left size_but hint"><?php echo $lang['ftp'] ?></button>
			</form>
