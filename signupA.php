...
<body dir="ltr">
		...
		<ul class="nav navbar-nav navbar-right">
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu">
					<li><a href="signupA.php?lang=fr"><img src="images/fr.png" width="25px"
							height="25px" /><?php echo $lang['lang_fr'] ?></a></li>
					<li><a href="signupA.php?lang=en"><img src="images/en.png" width="25px"
	...
	<div class="row">
		...
		<div class="container-fluid content col-sm-8" align="center">
			...
			<form action="LOG.php"  class="form-group" method="post" name="f">
