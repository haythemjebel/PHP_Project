		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu">
					<li><a href="signupE.php?lang=fr"><img src="images/fr.png" width="25px"
							height="25px" /><?php echo $lang['lang_fr'] ?></a></li>
					<li><a href="signupE.php?lang=en"><img src="images/en.png" width="25px"
...
<div class="row ">
        ...
        <form action="signupENT.php" class="form-group" method='POST'>
          <div class="form-group">
            <input type="text" placeholder="<?php echo $lang['YName'] ?>"
              class="form-control hint" id="name" name="name" required>
          </div>
          <div class="form-group">
            <input type="text" placeholder="<?php echo $lang['YDomaine'] ?>"
