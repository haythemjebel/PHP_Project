...
<nav class="navbar navbar-inverse ">
    <div class="container-fluid">
        <div class="navbar-header">
          <a class="navbar-brand" href="LoginE.php"><img src="images/logofisrjob.png"
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown"><a class="dropdown-toggle"
            ...
            <?php echo $lang['profil'] ?></a><ul class="dropdown-menu">
              ...
              <li><a href="updateE.php"><span class="glyphicon glyphicon-wrench"></span>&nbsp;<?php echo $lang['upd'] ?></a></li>
              <li><a href="deconnexionE.php"><span class="glyphicon glyphicon-log-out"></span>&nbsp;<?php echo $lang['lgou'] ?></a></li>
                </ul>
                </li>
              </li>
              <li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu">
					<li><a href="acceuillENT.php?lang=fr"><img src="images/fr.png" width="25px"
							height="25px" /><?php echo $lang['lang_fr'] ?></a></li>
					<li><a href="acceuillENT.php?lang=en"><img src="images/en.png" width="25px"
...
<div class="row">
  ...
  <thead>
    <tr>
      <th scope="col"><?php echo $lang['ENT1'] ?></th>
      <th scope="col"><?php echo $lang['ENT2'] ?></th>
      <th scope="col"><?php echo $lang['ENT3'] ?></th>
      <th scope="col"><?php echo $lang['ENT4'] ?></th>
      <th scope="col"><?php echo $lang['ENT5'] ?></th>
      <th scope="col"><?php echo $lang['ENT6'] ?></th>
      <th scope="col"><?php echo $lang['ENT7'] ?></th>
      <th scope="col"><?php echo $lang['ENT8'] ?></th>
      <th scope="col"><?php echo $lang['ENT9'] ?></th>
    </tr>
  </thead>
  <tbody>
  <?php
  include_once 'db.php';
   ...
   if (mysql_num_rows($result)>0) {
    while($row = mysql_fetch_assoc($result)) { 
            ?>
                <tr>
                    <td><?php echo '<img width="140px" height ="140px" src="images/' . $row["image"] . '">'; ?></td>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLongTitle"><?php echo $lang['MmING'] ?></h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="contactcvPFE.php" class="form-group" method='POST'>
