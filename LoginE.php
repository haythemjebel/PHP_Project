...
<body dir="ltr">
	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav navbar-right">
			<li><a href="signupE.php"><span class="glyphicon glyphicon-user"></span>
			<?php echo $lang['signup'] ?></a></li>
			<li class="dropdown"><a class="dropdown-toggle"
				data-toggle="dropdown" ><?php echo $lang['Langue'] ?><span class="caret"></span></a>
				<ul class="dropdown-menu">
					<li><a href="LoginE.php?lang=fr"><img src="images/fr.png" width="25px"
							height="25px" /><?php echo $lang['lang_fr'] ?></a></li>
					<li><a href="LoginE.php?lang=en"><img src="images/en.png" width="25px"
	...
	<div class="row">
		...
		<div class="container-fluid content col-sm-8" align="center">
			...
			<h2><?php echo $lang['titrepage'] ?></h2>
			<form action="LLoginE.php"  class="form-group" method="post" name="f">
				...
				<div class="form-group">
					<input type="password" placeholder="<?php echo $lang['password'] ?>"
						class="form-control hint" id="password" name="password" required>
				</div>
				<div class="checkbox">
					<label class="margin-item hint"><input type="checkbox">
							<?php echo $lang['rmember'] ?></label>
				</div>
				<button type="submit"
					class="btn btn-warning margin-item size_but hint"><?php echo $lang['log'] ?></button>
				<a class="btn btn-warning margin-item margin-left size_but hint" href = "MdpE.php"><?php echo $lang['ftp'] ?></a>

			</form>
			 <?php echo $lang['Sessionclean'] ?><a href = "logoutttE.php" tite = "Logout">Session.
		</div>
		<div class="col-sm-2"></div>
	</div>
