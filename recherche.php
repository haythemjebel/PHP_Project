...
<title><?php echo $lang['rech'] ?></title>
<style>
.hint {
            ...
            <li><a href="recherche.php"><span class="glyphicon glyphicon-search"></span>&nbsp;<?php echo $lang['rech'] ?></a></li>
              ...
              <li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu">
					<li><a href="recherche.php?lang=fr"><img src="images/fr.png" width="25px"
							height="25px" /><?php echo $lang['lang_fr'] ?></a></li>
					<li><a href="recherche.php?lang=en"><img src="images/en.png" width="25px"
